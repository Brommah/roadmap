...
export function findLane(text: string, lanes: Lane[]): Lane | undefined {
  ...
  const KEYWORD_LANE_MAP: Record<string, string[]> = {
    // CEF keywords - B3 Marketing group
    's0': ['lane-s0'],
    'content wiki': ['lane-s0'],
    'core content': ['lane-s0'],
    'product content': ['lane-s0'],
    's2': ['lane-s2'],
    'cef website': ['lane-s2'],
    'website': ['lane-s2'],
    'vertical pages': ['lane-s2'],
    's3': ['lane-s3'],
    'campaigns': ['lane-s3'],
    'cef campaigns': ['lane-s3'],
    'b3': ['lane-b3'],
    'product marketing': ['lane-b3'],
    // CEF keywords - B4 Sales group
    's1': ['lane-s1'],
    'cef demo': ['lane-s1'],
    'sales collateral': ['lane-s1'],
    'decks': ['lane-s1'],
    's4': ['lane-s4'],
    'enterprise gtm': ['lane-s4'],
    'enterprise g2m': ['lane-s4'],
    'g2m wiki': ['lane-b4'],
    'b4': ['lane-b4'],
    // CERE keywords
    'dac': ['lane-dac'],
